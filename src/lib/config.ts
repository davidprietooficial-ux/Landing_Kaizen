...
export const TEAM: { name: string; role: string; photo?: string; pos?: string; social?: string }[] = [
  { name: 'Juan C. Moreno', role: 'Editor, socio y marketer', photo: '/img/team-1.webp', social: 'https://www.instagram.com/juan.edita/' },
  { name: 'Jennifer Correa', role: 'Community Manager', photo: '/img/jennifer-retrato.webp', social: 'https://www.instagram.com/jennifercs07/' },
...
// iw/ih: dimensiones intrínsecas del archivo (evitan saltos de layout).
...
// iw/ih: dimensiones intrínsecas de las imágenes (evitan saltos de layout).
